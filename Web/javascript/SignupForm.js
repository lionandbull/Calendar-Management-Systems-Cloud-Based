(function(EventEmitter, tmpl, Cognito) {
  ...
  function handleSubmit(event) {
    ...
    // }
    startLoading()
    if($inputs.username.value === "" || $inputs.nickname.value === "" || $inputs.email.value === "" || $inputs.password.value === ""){
      addAlert({
        type: 'error',
    ...
    Cognito.signUp($inputs.username.value, $inputs.nickname.value, $inputs.email.value, $inputs.password.value)
