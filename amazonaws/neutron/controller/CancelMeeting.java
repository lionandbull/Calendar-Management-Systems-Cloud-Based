...
public class CancelMeeting implements RequestStreamHandler {
	 ...
	 * @throws Exception */
	public boolean cancelMeetingFromMySQL(String calID, String meetingID) throws Exception {        
		DatabaseDAO dao = new DatabaseDAO();
		return dao.cancelMeeting(calID, meetingID);
	}
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        try {        
	        ...
	        if (event != null) {
		        ...
		        if ( event.get("meetingID") != null) {
	                meetingID = (String)event.get("meetingID");
	            }
		        
	        }
	        String result;
	        
	        if (!cancelMeetingFromMySQL(calID, meetingID)) {
	        	result = "Failed to cancel meeting!";
	        }
	        else {
	        	result = "Succeed!";
	        }
