...
public class RemoveDate implements RequestStreamHandler {

	/** Delete data from MySQL 
	 * @throws Exception */
	public boolean removeDateFromMySQL(String calID, String date) throws Exception {        
		DatabaseDAO dao = new DatabaseDAO();
		return dao.removeDate(calID, date);
	}
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        try {        
	        ...
	        String result;
	        if (removeDateFromMySQL(calID, date) == false) {
	        	result = "The date: " + date + " doesn't exist!";
	        }
	        else {
	        	result = "Succeed";
	        }
