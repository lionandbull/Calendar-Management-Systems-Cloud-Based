...
public class RetrieveMonthlyMeetings implements RequestStreamHandler {
	
	
	/** Load up MySQL with given key */
	public ArrayList<Meeting> retrieveMonthlyMeetingsFromMySQL(String calID, String yearMonth) throws Exception {   
		DatabaseDAO dao = new DatabaseDAO();
		return dao.retrieveMonthlyMeetings(calID, yearMonth);
	}
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        try {        
	        ...
	        if (event.get("queryStringParameters") != null) {
                ...
                if ( qps.get("yearMonth") != null) {
                	
                	yearMonth = (String)qps.get("yearMonth");
                }
            }
	        
	        
	        List<Meeting> result = retrieveMonthlyMeetingsFromMySQL(calID, yearMonth);
