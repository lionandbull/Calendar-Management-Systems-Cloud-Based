...
public class RetrieveDailyMeetings implements RequestStreamHandler {
	
	
	/** Load up MySQL with given key */
	public ArrayList<Meeting> retrieveDailyMeetingsFromMySQL(String calID, String meetDate) throws Exception {   
		DatabaseDAO dao = new DatabaseDAO();
		return dao.retrieveDailyMeetings(calID, meetDate);
	}
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        try {        
	        ...
	        if (event.get("queryStringParameters") != null) {
                ...
                if ( qps.get("meetDate") != null) {
                	
                	meetDate = (String)qps.get("meetDate");
                }
            }
	        
	        
	        List<Meeting> result = retrieveDailyMeetingsFromMySQL(calID, meetDate);
